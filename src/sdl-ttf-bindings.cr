...
lib LibSDL
  ...
  fun ttf_init = TTF_Init() : bool
  fun ttf_open_font = TTF_OpenFont(file : LibC::Char*, ptsize : LibC::Float) : TTFFont*
  fun ttf_open_font_io = TTF_OpenFontIO(src : IOStream*, closeio : bool, ptsize : LibC::Float) : TTFFont*
  ...
  fun ttf_set_font_size = TTF_SetFontSize(font : TTFFont*, ptsize : LibC::Float) : bool
  fun ttf_set_font_size_dpi = TTF_SetFontSizeDPI(font : TTFFont*, ptsize : LibC::Float, hdpi : LibC::Int, vdpi : LibC::Int) : bool
  fun ttf_get_font_size = TTF_GetFontSize(font : TTFFont*) : LibC::Float
  fun ttf_get_font_dpi = TTF_GetFontDPI(font : TTFFont*, hdpi : LibC::Int*, vdpi : LibC::Int*) : bool
  ...
  fun ttf_set_font_outline = TTF_SetFontOutline(font : TTFFont*, outline : LibC::Int) : bool
  ...
  fun ttf_set_font_sdf = TTF_SetFontSDF(font : TTFFont*, enabled : bool) : bool
  fun ttf_get_font_sdf = TTF_GetFontSDF(font : TTFFont*) : bool
  ...
  fun ttf_set_font_kerning = TTF_SetFontKerning(font : TTFFont*, enabled : bool) : Void
  fun ttf_get_font_kerning = TTF_GetFontKerning(font : TTFFont*) : bool
  fun ttf_font_is_fixed_width = TTF_FontIsFixedWidth(font : TTFFont*) : bool
  fun ttf_font_is_scalable = TTF_FontIsScalable(font : TTFFont*) : bool
  ...
  fun ttf_set_font_direction = TTF_SetFontDirection(font : TTFFont*, direction : TTFDirection) : bool
  fun ttf_get_font_direction = TTF_GetFontDirection(font : TTFFont*) : TTFDirection
  fun ttf_set_font_script = TTF_SetFontScript(font : TTFFont*, script : LibC::Char*) : bool
  fun ttf_get_glyph_script = TTF_GetGlyphScript(ch : UInt32, script : LibC::Char*, script_size : LibC::SizeT) : bool
  fun ttf_set_font_language = TTF_SetFontLanguage(font : TTFFont*, language_bcp47 : LibC::Char*) : bool
  fun ttf_font_has_glyph = TTF_FontHasGlyph(font : TTFFont*, ch : UInt32) : bool
  ...
  fun ttf_get_glyph_metrics = TTF_GetGlyphMetrics(font : TTFFont*, ch : UInt32, minx : LibC::Int*, maxx : LibC::Int*, miny : LibC::Int*, maxy : LibC::Int*, advance : LibC::Int*) : bool
  fun ttf_get_glyph_kerning = TTF_GetGlyphKerning(font : TTFFont*, previous_ch : UInt32, ch : UInt32, kerning : LibC::Int*) : bool
  fun ttf_get_string_size = TTF_GetStringSize(font : TTFFont*, text : LibC::Char*, length : LibC::SizeT, w : LibC::Int*, h : LibC::Int*) : bool
  fun ttf_get_string_size_wrapped = TTF_GetStringSizeWrapped(font : TTFFont*, text : LibC::Char*, length : LibC::SizeT, wrap_width : LibC::Int, w : LibC::Int*, h : LibC::Int*) : bool
  fun ttf_measure_string = TTF_MeasureString(font : TTFFont*, text : LibC::Char*, length : LibC::SizeT, max_width : LibC::Int, measured_width : LibC::Int*, measured_length : LibC::SizeT*) : bool
  ...
  fun ttf_draw_surface_text = TTF_DrawSurfaceText(text : TTFText*, x : LibC::Int, y : LibC::Int, surface : Surface*) : bool
  ...
  fun ttf_draw_renderer_text = TTF_DrawRendererText(text : TTFText*, x : LibC::Float, y : LibC::Float) : bool
  ...
  fun ttf_set_text_engine = TTF_SetTextEngine(text : TTFText*, engine : TTFTextEngine*) : bool
  fun ttf_get_text_engine = TTF_GetTextEngine(text : TTFText*) : TTFTextEngine*
  fun ttf_set_text_font = TTF_SetTextFont(text : TTFText*, font : TTFFont*) : bool
  fun ttf_get_text_font = TTF_GetTextFont(text : TTFText*) : TTFFont*
  fun ttf_set_text_color = TTF_SetTextColor(text : TTFText*, r : UInt8, g : UInt8, b : UInt8, a : UInt8) : bool
  fun ttf_set_text_color_float = TTF_SetTextColorFloat(text : TTFText*, r : LibC::Float, g : LibC::Float, b : LibC::Float, a : LibC::Float) : bool
  fun ttf_get_text_color = TTF_GetTextColor(text : TTFText*, r : UInt8*, g : UInt8*, b : UInt8*, a : UInt8*) : bool
  fun ttf_get_text_color_float = TTF_GetTextColorFloat(text : TTFText*, r : LibC::Float*, g : LibC::Float*, b : LibC::Float*, a : LibC::Float*) : bool
  fun ttf_set_text_position = TTF_SetTextPosition(text : TTFText*, x : LibC::Int, y : LibC::Int) : bool
  fun ttf_get_text_position = TTF_GetTextPosition(text : TTFText*, x : LibC::Int*, y : LibC::Int*) : bool
  fun ttf_set_text_wrap_width = TTF_SetTextWrapWidth(text : TTFText*, wrap_width : LibC::Int) : bool
  fun ttf_get_text_wrap_width = TTF_GetTextWrapWidth(text : TTFText*, wrap_width : LibC::Int*) : bool
  fun ttf_set_text_wrap_whitespace_visible = TTF_SetTextWrapWhitespaceVisible(text : TTFText*, visible : bool) : bool
  fun ttf_text_wrap_whitespace_visible = TTF_TextWrapWhitespaceVisible(text : TTFText*) : bool
  fun ttf_set_text_string = TTF_SetTextString(text : TTFText*, string : LibC::Char*, length : LibC::SizeT) : bool
  fun ttf_insert_text_string = TTF_InsertTextString(text : TTFText*, offset : LibC::Int, string : LibC::Char*, length : LibC::SizeT) : bool
  fun ttf_append_text_string = TTF_AppendTextString(text : TTFText*, string : LibC::Char*, length : LibC::SizeT) : bool
  fun ttf_delete_text_string = TTF_DeleteTextString(text : TTFText*, offset : LibC::Int, length : LibC::Int) : bool
  fun ttf_get_text_size = TTF_GetTextSize(text : TTFText*, w : LibC::Int*, h : LibC::Int*) : bool
  fun ttf_get_text_sub_string = TTF_GetTextSubString(text : TTFText*, offset : LibC::Int, substring : TTFSubString*) : bool
  fun ttf_get_text_sub_string_for_line = TTF_GetTextSubStringForLine(text : TTFText*, line : LibC::Int, substring : TTFSubString*) : bool
  ...
  fun ttf_get_text_sub_string_for_point = TTF_GetTextSubStringForPoint(text : TTFText*, x : LibC::Int, y : LibC::Int, substring : TTFSubString*) : bool
  fun ttf_get_previous_text_sub_string = TTF_GetPreviousTextSubString(text : TTFText*, substring : TTFSubString*, previous : TTFSubString*) : bool
  fun ttf_get_next_text_sub_string = TTF_GetNextTextSubString(text : TTFText*, substring : TTFSubString*, next : TTFSubString*) : bool
  fun ttf_update_text = TTF_UpdateText(text : TTFText*) : bool
