...
lib LibSDL
  ...
  fun img_load_typed_io = IMG_LoadTyped_IO(src : IOStream*, closeio : Bool, type : LibC::Char*) : Surface*
  fun img_load = IMG_Load(file : LibC::Char*) : Surface*
  fun img_load_io = IMG_Load_IO(src : IOStream*, closeio : Bool) : Surface*
  fun img_load_texture = IMG_LoadTexture(renderer : Renderer*, file : LibC::Char*) : Texture*
  fun img_load_texture_io = IMG_LoadTexture_IO(renderer : Renderer*, src : IOStream*, closeio : Bool) : Texture*
  fun img_load_texture_typed_io = IMG_LoadTextureTyped_IO(renderer : Renderer*, src : IOStream*, closeio : Bool, type : LibC::Char*) : Texture*
  fun img_is_avif = IMG_isAVIF(src : IOStream*) : Bool
  fun img_is_ico = IMG_isICO(src : IOStream*) : Bool
  fun img_is_cur = IMG_isCUR(src : IOStream*) : Bool
  fun img_is_bmp = IMG_isBMP(src : IOStream*) : Bool
  fun img_is_gif = IMG_isGIF(src : IOStream*) : Bool
  fun img_is_jpg = IMG_isJPG(src : IOStream*) : Bool
  fun img_is_jxl = IMG_isJXL(src : IOStream*) : Bool
  fun img_is_lbm = IMG_isLBM(src : IOStream*) : Bool
  fun img_is_pcx = IMG_isPCX(src : IOStream*) : Bool
  fun img_is_png = IMG_isPNG(src : IOStream*) : Bool
  fun img_is_pnm = IMG_isPNM(src : IOStream*) : Bool
  fun img_is_svg = IMG_isSVG(src : IOStream*) : Bool
  fun img_is_qoi = IMG_isQOI(src : IOStream*) : Bool
  fun img_is_tif = IMG_isTIF(src : IOStream*) : Bool
  fun img_is_xcf = IMG_isXCF(src : IOStream*) : Bool
  fun img_is_xpm = IMG_isXPM(src : IOStream*) : Bool
  fun img_is_xv = IMG_isXV(src : IOStream*) : Bool
  fun img_is_webp = IMG_isWEBP(src : IOStream*) : Bool
  ...
  fun img_save_avif = IMG_SaveAVIF(surface : Surface*, file : LibC::Char*, quality : LibC::Int) : Bool
  fun img_save_avif_io = IMG_SaveAVIF_IO(surface : Surface*, dst : IOStream*, closeio : Bool, quality : LibC::Int) : Bool
  fun img_save_png = IMG_SavePNG(surface : Surface*, file : LibC::Char*) : Bool
  fun img_save_png_io = IMG_SavePNG_IO(surface : Surface*, dst : IOStream*, closeio : Bool) : Bool
  fun img_save_jpg = IMG_SaveJPG(surface : Surface*, file : LibC::Char*, quality : LibC::Int) : Bool
  fun img_save_jpg_io = IMG_SaveJPG_IO(surface : Surface*, dst : IOStream*, closeio : Bool, quality : LibC::Int) : Bool
  fun img_load_animation = IMG_LoadAnimation(file : LibC::Char*) : IMGAnimation*
  fun img_load_animation_io = IMG_LoadAnimation_IO(src : IOStream*, closeio : Bool) : IMGAnimation*
  fun img_load_animation_typed_io = IMG_LoadAnimationTyped_IO(src : IOStream*, closeio : Bool, type : LibC::Char*) : IMGAnimation*
